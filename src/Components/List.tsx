...
const List : React.FC<TaskProps >= ({id,job,isDone,doneTask,delTask,updateTask}) => {
...
<div className="list">
      <div className="group animate__animated animate__fadeInLeft border mb-3 overflow-hidden border-neutral-700 p-5 flex justify-between items-center">
       {isEdit ? (<EditInput updateInput={updateInput} handleUpdateInput={handleUpdateInput} handleUpateInputBlur={handleUpateInputBlur}/>) : (<div className=" flex items-center gap-3">
            <input
